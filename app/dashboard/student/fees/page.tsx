...
export default function StudentFeesPage() {
  ...
  const payFee = async (fee: any) => {
    ...
    try {
      ...
      const { data } = await api.post('/student/fees/create-order', { fee_id: fee.id });
      ...
      const options = {
        ...
        handler: async (response: any) => {
          try {
            await api.post('/student/fees/verify-payment', {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">View and pay your school fees securely via Razorpay.</p>
      </div>
