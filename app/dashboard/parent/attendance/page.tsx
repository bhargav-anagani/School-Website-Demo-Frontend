...
export default function ParentChildAttendancePage() {
  ...
  useEffect(() => {
    api.get('/parent/child/attendance').then(r => {
      setData(r.data.data || []);
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div>
        <h2 className="text-2xl font-display font-bold text-gray-900 dark:text-white">Child's Attendance</h2>
      ...
      {summary && (
        <div className="card p-6">
          ...
          {pct < 75 && (
            <p className="text-xs text-red-500 mt-2">⚠ Attendance below 75%. Please ensure your child maintains regular attendance.</p>
          )}
        </div>
      )}
